<template>
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" :rules="rules">
      <!-- <el-form-item label="试卷类型：" prop="gradeLevel" required>
        <el-input v-model="form.gradeLevel" placeholder="试卷类型"  @change="levelChange" clearable disabled>
        </el-input>
      </el-form-item>
      <el-form-item label="题型：" prop="subjectId" required>
        <el-input v-model="form.subjectId" placeholder="题型" disabled>
        </el-input>
      </el-form-item> -->
          ...
          questionApi.edit(this.form).then(re => {
            if (re.code === 1) {
              ...
              _this.delCurrentView(_this).then(() => {
                _this.$router.push('/exam/passage/edit/edit')
              })
            } else {
