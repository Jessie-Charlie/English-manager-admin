...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'passage/list',
        component: () => import('@/views/exam/passage/list'),
        name: 'ExamQuestionPageList',
        meta: { title: '短文列表', noCache: true }
      },
      {
        path: 'question/list',
      ...
      {
        path: 'passage/edit/edit',
        component: () => import('@/views/exam/passage/edit/edit'),
        name: 'PassageEdit',
        meta: { title: '短文编辑', noCache: true, activeMenu: '/exam/passage/list' },
        hidden: true
      },
      {
    ...
    children: [
      {
        ...
        meta: { title: '题型列表', noCache: true }
      },
      {
        path: 'subject/edit',
        component: () => import('@/views/education/subject/edit'),
        name: 'EducationSubjectEditPage',
        meta: { title: '题型编辑', noCache: true, activeMenu: '/education/subject/list' },
        hidden: true
      }
    ]
  },
